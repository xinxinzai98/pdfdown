...
print("=" * 70)
print("测试 RIS 文件批量下载（所有 DOI，不使用代理）")
print("=" * 70)
...
print(f"📊 下载总结")
print("=" * 70)
print(f"总计: {len(test_dois)} 篇")
print(f"成功: {success_count} 篇")
print(f"失败: {len(test_dois) - success_count} 篇")
